<?php
/**
 * Session Debugging Page - FOR STAFF USE
...
<head>
    <meta charset="UTF-8">
    <title>Session Debug - Staff</title>
    <style>
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <ol>
                ...
                <li>Visit <code>/admin/session_debug.php</code> in Tab 1 and take a screenshot</li>
                <li>Open <strong>Tab 2</strong> and login as <strong>Staff</strong></li>
                <li>Visit this page (<code>/staff/session_debug.php</code>) in Tab 2 and take a screenshot</li>
