...
<body>
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="page-header">
            <div>
                ...
                <p>View and update student records, RFID cards, and bus assignments</p>
            </div>
            <a href="<?= SITE_URL ?>/staff/create_student.php" class="btn btn-primary">
        ...
        <form method="GET" action="" class="search-bar">
            ...
            <?php if ($search): ?>
                <a href="<?= SITE_URL ?>/staff/students.php" class="btn btn-search">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="<?= SITE_URL ?>/staff/edit_student.php?id=<?= $student['student_id'] ?>">
    ...
    <?php include 'includes/logout_feedback_interceptor.php'; ?></body>
</html>
